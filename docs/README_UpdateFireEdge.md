...
At this point the incident's "Fire Edge" is now up to date. If all morning edits are complete, I would recommend users proceed by running the [GISS Workflow Assistant tool](/docs/README_GISSWorkflowAssistant.md) prior to syncing.
